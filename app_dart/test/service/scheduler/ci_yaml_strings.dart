...
const String experimentalEngineCiYaml = r'''
...
const experimentalFlutterCiYaml = r'''
# This is intentionally a subset of .ci.yaml from the master branch.
enabled_branches:
  - ios-experimental
...
targets:
  ...
  - name: Linux_pixel_7pro integration_ui_driver
    bringup: true # Flaky https://github.com/flutter/flutter/issues/167638
    recipe: devicelab/devicelab_drone
    presubmit: false
    timeout: 60
    properties:
